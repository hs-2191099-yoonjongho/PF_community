...
class FileServiceTest {
    ...
    void uploadFilesToStorage_processes_all_files_and_returns_results() throws Exception {
        ...
        StoredFile storedFile1 = new StoredFile(
                "posts/123/file1.png", "test1.png", "image/png", 8, "http://localhost:8080/files/posts/123/file1.png");
        StoredFile storedFile2 = new StoredFile(
                "posts/123/file2.jpg", "test2.jpg", "image/jpeg", 8, "http://localhost:8080/files/posts/123/file2.jpg");
